...
using System;
namespace Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert
{
    /// <summary>
    /// Builds and executes requests for operations under \feature-flags\v3\{appId}\flags\{flagName}\portals\batch\upsert
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class UpsertRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert.UpsertRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpsertRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/feature-flags/v3/{appId}/flags/{flagName}/portals/batch/upsert", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert.UpsertRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public UpsertRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/feature-flags/v3/{appId}/flags/{flagName}/portals/batch/upsert", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert.UpsertRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert.UpsertRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.HubSpot.OpenApiClient.FeatureFlags.V3.Item.Flags.Item.Portals.Batch.Upsert.UpsertRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
