...
using Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Batch;
using Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Item;
...
using System;
namespace Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders
{
    /// <summary>
    /// Builds and executes requests for operations under \cms\pages\2026-03\landing-pages\folders
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class FoldersRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The batch property</summary>
        public global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Batch.BatchRequestBuilder Batch
        {
            get => new global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Batch.BatchRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>Gets an item from the Soenneker.HubSpot.OpenApiClient.cms.pages.TwoZeroTwoSixZeroThree.landingPages.folders.item collection</summary>
        /// <param name="position">The ID of the landing page folder.</param>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Item.WithObjectItemRequestBuilder"/></returns>
        public global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Item.WithObjectItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("objectId", position);
                return new global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.Item.WithObjectItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FoldersRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cms/pages/2026-03/landing-pages/folders{?after*,archived*,createdAfter*,createdAt*,createdBefore*,limit*,property*,sort*,updatedAfter*,updatedAt*,updatedBefore*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public FoldersRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/cms/pages/2026-03/landing-pages/folders{?after*,archived*,createdAfter*,createdAt*,createdBefore*,limit*,property*,sort*,updatedAfter*,updatedAt*,updatedBefore*}", rawUrl)
        {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder.FoldersRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder.FoldersRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.HubSpot.OpenApiClient.Cms.Pages.TwoZeroTwoSixZeroThree.LandingPages.Folders.FoldersRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get the list of Landing Page Folders. Supports paging and filtering. This method would be useful for an integration that examined these models and used an external service to suggest edits.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Specifies which properties of the landing page folders to include in the response.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
