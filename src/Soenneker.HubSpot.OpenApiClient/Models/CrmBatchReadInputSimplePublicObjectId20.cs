...
#nullable restore
        ...
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectId21> Inputs { get; set; }
#endif
        /// <summary>An array of strings representing the names of the properties to be returned in the response.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Properties { get; set; }
#endif
        /// <summary>An array of strings representing the names of the properties for which the history of previous values should be returned.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
