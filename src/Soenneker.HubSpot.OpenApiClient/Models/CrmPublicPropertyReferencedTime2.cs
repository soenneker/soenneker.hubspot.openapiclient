...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmPublicPropertyReferencedTime2 : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>A string that denotes the property used as the reference for the time operation.</summary>
...
#nullable restore
        ...
        public string Property { get; set; }
#endif
        /// <summary>A string indicating the type of reference used for the property.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicPropertyReferencedTime2"/> and sets the default values.
        /// </summary>
        public CrmPublicPropertyReferencedTime2()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicPropertyReferencedTime2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicPropertyReferencedTime2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicPropertyReferencedTime2();
        }
        /// <summary>
