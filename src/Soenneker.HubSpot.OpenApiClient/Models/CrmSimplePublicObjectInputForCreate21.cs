...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmSimplePublicObjectInputForCreate21 : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>An array of associations that define the relationships between the new object and other existing objects. Each association is represented by a &apos;PublicAssociationsForObject&apos; object.</summary>
...
#nullable restore
        ...
        /// </summary>
        public CrmSimplePublicObjectInputForCreate21()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate21"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate21 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate21();
        }
        /// <summary>
