...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>A boolean indicating whether to include objects that have no value set for the date property.</summary>
        public bool? IncludeObjectsWithNoValueSet { get; set; }
        /// <summary>An integer representing the lower bound of the date range, in Unix timestamp format (int64).</summary>
...
#nullable restore
        ...
        /// <summary>An integer representing the upper bound of the date range, in Unix timestamp format (int64).</summary>
