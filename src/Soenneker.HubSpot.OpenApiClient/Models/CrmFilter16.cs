...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmFilter16 : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>An optional string value used in range-based filters to specify the upper bound of the range.</summary>
...
#nullable restore
        ...
        public string PropertyName { get; set; }
#endif
        /// <summary>The value to be compared against the object&apos;s property. It is a string used in conjunction with the operator to filter results.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string Value { get; set; }
#endif
        /// <summary>An array of strings representing multiple values for comparison. This is used with operators that support multiple values, such as &apos;IN&apos; or &apos;NOT_IN&apos;.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmFilter16"/> and sets the default values.
        /// </summary>
        public CrmFilter16()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmFilter16"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmFilter16 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmFilter16();
        }
        /// <summary>
