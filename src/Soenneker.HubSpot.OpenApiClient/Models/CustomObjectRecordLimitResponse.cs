...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CustomObjectRecordLimitResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>An array containing usage details for each object type, with each entry providing specific usage information for a particular object type.</summary>
...
#nullable restore
        ...
        /// </summary>
        public CustomObjectRecordLimitResponse()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CustomObjectRecordLimitResponse"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CustomObjectRecordLimitResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CustomObjectRecordLimitResponse();
        }
        /// <summary>
