...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CRM_Properties_PropertyCreate : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_dataSensitivity? DataSensitivity { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_fieldType? FieldType { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_OptionInput>? Options { get; set; }
#nullable restore
#else
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_OptionInput> Options { get; set; }
#endif
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate"/> and sets the default values.
        /// </summary>
        public CRM_Properties_PropertyCreate()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "dataSensitivity", n => { DataSensitivity = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_dataSensitivity>(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "displayOrder", n => { DisplayOrder = n.GetIntValue(); } },
                { "externalOptions", n => { ExternalOptions = n.GetBoolValue(); } },
                { "fieldType", n => { FieldType = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_fieldType>(); } },
                ...
                { "options", n => { Options = n.GetCollectionOfObjectValues<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_OptionInput>(global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_OptionInput.CreateFromDiscriminatorValue)?.AsList(); } },
                { "referencedObjectType", n => { ReferencedObjectType = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_dataSensitivity>("dataSensitivity", DataSensitivity);
            writer.WriteStringValue("description", Description);
            writer.WriteIntValue("displayOrder", DisplayOrder);
            writer.WriteBoolValue("externalOptions", ExternalOptions);
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_fieldType>("fieldType", FieldType);
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_OptionInput>("options", Options);
            writer.WriteStringValue("referencedObjectType", ReferencedObjectType);
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CRM_Properties_PropertyCreate_type>("type", Type);
