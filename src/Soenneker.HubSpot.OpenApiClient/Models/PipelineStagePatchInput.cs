...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>A boolean indicating whether the pipeline stage is archived.</summary>
        public bool? Archived { get; set; }
        /// <summary>An integer specifying the order in which the stage appears relative to other stages.</summary>
        public int? DisplayOrder { get; set; }
        /// <summary>A string representing the name or title of the pipeline stage.</summary>
