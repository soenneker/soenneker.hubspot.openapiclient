...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class PublicRangedNumberPropertyOperation : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        /// <summary>An integer specifying the lower bound of the range.</summary>
...
#nullable restore
        ...
        public string Operator { get; set; }
#endif
        /// <summary>An integer specifying the upper bound of the range.</summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.PublicRangedNumberPropertyOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.PublicRangedNumberPropertyOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.PublicRangedNumberPropertyOperation();
        }
        /// <summary>
