...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class RangedDatePropertyOperation : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_operator? Operator { get; set; }
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_propertyType? PropertyType { get; set; }
...
#nullable restore
        ...
        /// </summary>
        public RangedDatePropertyOperation()
        {
            AdditionalData = new Dictionary<string, object>();
            PropertyType = global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_propertyType.DatetimeRanged;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "operator", n => { Operator = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_operator>(); } },
                { "operatorName", n => { OperatorName = n.GetStringValue(); } },
                { "propertyType", n => { PropertyType = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_propertyType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_operator>("operator", Operator);
            writer.WriteStringValue("operatorName", OperatorName);
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.RangedDatePropertyOperation_propertyType>("propertyType", PropertyType);
