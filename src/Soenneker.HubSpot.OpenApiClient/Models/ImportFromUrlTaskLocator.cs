...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class ImportFromUrlTaskLocator : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The ID of the import task.</summary>
...
#nullable restore
        ...
        public string Id { get; set; }
#endif
        /// <summary>A map of link names to associated URIs related to the import task. Each entry in the map is a string.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public static global::Soenneker.HubSpot.OpenApiClient.Models.ImportFromUrlTaskLocator CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.ImportFromUrlTaskLocator();
        }
        /// <summary>
