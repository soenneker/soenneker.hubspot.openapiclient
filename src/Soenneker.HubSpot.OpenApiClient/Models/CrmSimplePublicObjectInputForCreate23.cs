...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmSimplePublicObjectInputForCreate23 : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>An array of associations that link the new object to other objects. Each association specifies the target object and the types of associations.</summary>
...
#nullable restore
        ...
        /// </summary>
        public CrmSimplePublicObjectInputForCreate23()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate23"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate23 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectInputForCreate23();
        }
        /// <summary>
