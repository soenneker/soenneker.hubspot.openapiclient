...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class PublicThreadStatusChange : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>A boolean indicating whether this status change has been archived.</summary>
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.PublicClient Client { get; set; }
#endif
        /// <summary>The unique identifier of the conversation thread whose status is being changed.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string ConversationsThreadId { get; set; }
#endif
        /// <summary>The date and time when this status change was created, in ISO 8601 format.</summary>
        public DateTimeOffset? CreatedAt { get; set; }
        /// <summary>The identifier of the user or system that created this status change.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string CreatedBy { get; set; }
#endif
        /// <summary>The unique identifier for this status change.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>An array of objects representing the recipients involved in this status change.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.PublicRecipient> Recipients { get; set; }
#endif
        /// <summary>An array of objects representing the senders involved in this status change.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.ThreadStatusChangeType? Type { get; set; }
        /// <summary>The date and time when this status change was last updated, in ISO 8601 format.</summary>
        public DateTimeOffset? UpdatedAt { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.PublicThreadStatusChange"/> and sets the default values.
        /// </summary>
        public PublicThreadStatusChange()
        {
        ...
        public static global::Soenneker.HubSpot.OpenApiClient.Models.PublicThreadStatusChange CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "type", n => { Type = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.ThreadStatusChangeType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.ThreadStatusChangeType>("type", Type);
