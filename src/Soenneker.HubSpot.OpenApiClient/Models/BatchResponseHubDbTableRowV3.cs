...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class BatchResponseHubDbTableRowV3 : IAdditionalDataHolder, IParsable
...
#nullable enable
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.C_cms_StandardError>? Errors { get; set; }
#nullable restore
#else
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.C_cms_StandardError> Errors { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.HubDbTableRowV3>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.HubDbTableRowV3> Results { get; set; }
#endif
        ...
        /// </summary>
        public BatchResponseHubDbTableRowV3()
        {
        ...
        public static global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseHubDbTableRowV3 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseHubDbTableRowV3();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "errors", n => { Errors = n.GetCollectionOfObjectValues<global::Soenneker.HubSpot.OpenApiClient.Models.C_cms_StandardError>(global::Soenneker.HubSpot.OpenApiClient.Models.C_cms_StandardError.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::Soenneker.HubSpot.OpenApiClient.Models.C_cms_StandardError>("errors", Errors);
