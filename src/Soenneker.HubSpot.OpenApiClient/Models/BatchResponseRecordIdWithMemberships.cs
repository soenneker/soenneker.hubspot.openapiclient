...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class BatchResponseRecordIdWithMemberships : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>An array of results from the batch operation, each containing record IDs and their associated memberships.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.RecordIdWithMemberships>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.RecordIdWithMemberships> Results { get; set; }
#endif
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMembershipsStatus? Status { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMemberships"/> and sets the default values.
        /// </summary>
        public BatchResponseRecordIdWithMemberships()
        {
        ...
        public static global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMemberships CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMemberships();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMembershipsStatus>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.BatchResponseRecordIdWithMembershipsStatus>("status", Status);
