...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmPublicCalendarDatePropertyOperation2 : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string Operator { get; set; }
#endif
        /// <summary>A string specifying the unit of time for the operation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string TimeUnit { get; set; }
#endif
        /// <summary>An integer specifying the count of the time units for the operation.</summary>
        public int? TimeUnitCount { get; set; }
        /// <summary>A boolean indicating whether the fiscal year should be used.</summary>
        public bool? UseFiscalYear { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicCalendarDatePropertyOperation2"/> and sets the default values.
        /// </summary>
        public CrmPublicCalendarDatePropertyOperation2()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicCalendarDatePropertyOperation2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicCalendarDatePropertyOperation2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicCalendarDatePropertyOperation2();
        }
        /// <summary>
