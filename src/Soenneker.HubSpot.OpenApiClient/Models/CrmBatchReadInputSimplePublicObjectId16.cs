...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmBatchReadInputSimplePublicObjectId16 : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        public string IdProperty { get; set; }
#endif
        /// <summary>An array of SimplePublicObjectId objects, each containing an ID that identifies the CRM objects to be read.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CrmSimplePublicObjectId17> Inputs { get; set; }
#endif
        /// <summary>An array of strings representing the properties to be returned in the response. If any of the specified properties are not present on the requested objects, they will be ignored.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Properties { get; set; }
#endif
        /// <summary>An array of strings representing the properties to be returned along with their history of previous values. If any of the specified properties are not present on the requested objects, they will be ignored.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchReadInputSimplePublicObjectId16"/> and sets the default values.
        /// </summary>
        public CrmBatchReadInputSimplePublicObjectId16()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchReadInputSimplePublicObjectId16"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchReadInputSimplePublicObjectId16 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchReadInputSimplePublicObjectId16();
        }
        /// <summary>
