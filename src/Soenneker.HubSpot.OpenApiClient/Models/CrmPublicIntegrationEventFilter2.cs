...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmPublicIntegrationEventFilter2 : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>A string that uniquely identifies the type of event to be filtered. This property is used to specify which event type the filter applies to.</summary>
        public int? EventTypeId { get; set; }
        /// <summary>An array of filter lines that contain the metadata for the event filter. Each item in the array is a detailed specification of the criteria used to filter events.</summary>
...
#nullable restore
        ...
        /// </summary>
        public CrmPublicIntegrationEventFilter2()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicIntegrationEventFilter2"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicIntegrationEventFilter2 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicIntegrationEventFilter2();
        }
        /// <summary>
