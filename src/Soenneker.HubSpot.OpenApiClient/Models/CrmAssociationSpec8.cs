...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmAssociationSpec8 : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmAssociationSpec8"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmAssociationSpec8 CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmAssociationSpec8();
        }
        /// <summary>
