...
#nullable restore
        ...
        public string ComparisonPropertyName { get; set; }
#endif
        /// <summary>A string representing the default value to use for comparison if no other value is set.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string OperationType { get; set; }
#endif
        /// <summary>A string indicating the comparison operator to use, with valid values being &apos;IS_BEFORE&apos; and &apos;IS_AFTER&apos;.</summary>
