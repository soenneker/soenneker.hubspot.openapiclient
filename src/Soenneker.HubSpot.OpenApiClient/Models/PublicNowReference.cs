...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>An integer representing the hour part of the current time.</summary>
        public int? Hour { get; set; }
        /// <summary>An integer representing the millisecond part of the current time.</summary>
        public int? Millisecond { get; set; }
        /// <summary>An integer representing the minute part of the current time.</summary>
        ...
        /// <summary>An integer representing the second part of the current time.</summary>
