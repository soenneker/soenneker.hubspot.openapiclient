...
namespace Soenneker.HubSpot.OpenApiClient.Models
{
    ...
    public partial class CrmBatchResponsePublicAssociationDefinitionUserConfiguration : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>An array of user configurations for public association definitions, representing the outcome of the batch operation.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicAssociationDefinitionUserConfiguration>? Results { get; set; }
#nullable restore
#else
        public List<global::Soenneker.HubSpot.OpenApiClient.Models.CrmPublicAssociationDefinitionUserConfiguration> Results { get; set; }
#endif
        ...
        public global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfigurationStatus? Status { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfiguration"/> and sets the default values.
        /// </summary>
        public CrmBatchResponsePublicAssociationDefinitionUserConfiguration()
        {
        ...
        public static global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfiguration CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfiguration();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfigurationStatus>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Soenneker.HubSpot.OpenApiClient.Models.CrmBatchResponsePublicAssociationDefinitionUserConfigurationStatus>("status", Status);
