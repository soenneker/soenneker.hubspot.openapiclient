...
using Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.Property;
...
using System;
namespace Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \events\2026-09\event-definitions\{eventName}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithEventNameItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>The property property</summary>
        public global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.Property.PropertyRequestBuilder Property
        {
            get => new global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.Property.PropertyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.WithEventNameItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEventNameItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/2026-09/event-definitions/{eventName}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.WithEventNameItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithEventNameItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/events/2026-09/event-definitions/{eventName}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.WithEventNameItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.HubSpot.OpenApiClient.Events.TwoZeroTwoSixZeroNine.EventDefinitions.Item.WithEventNameItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
