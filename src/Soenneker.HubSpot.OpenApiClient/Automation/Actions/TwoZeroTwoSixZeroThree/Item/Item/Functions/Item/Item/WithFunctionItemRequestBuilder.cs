...
using System;
namespace Soenneker.HubSpot.OpenApiClient.Automation.Actions.TwoZeroTwoSixZeroThree.Item.Item.Functions.Item.Item
{
    /// <summary>
    /// Builds and executes requests for operations under \automation\actions\2026-03\{appId}\{definitionId}\functions\{functionType}\{functionId}
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class WithFunctionItemRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Automation.Actions.TwoZeroTwoSixZeroThree.Item.Item.Functions.Item.Item.WithFunctionItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithFunctionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}/{functionId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.HubSpot.OpenApiClient.Automation.Actions.TwoZeroTwoSixZeroThree.Item.Item.Functions.Item.Item.WithFunctionItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithFunctionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/automation/actions/2026-03/{appId}/{definitionId}/functions/{functionType}/{functionId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.HubSpot.OpenApiClient.Automation.Actions.TwoZeroTwoSixZeroThree.Item.Item.Functions.Item.Item.WithFunctionItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.HubSpot.OpenApiClient.Automation.Actions.TwoZeroTwoSixZeroThree.Item.Item.Functions.Item.Item.WithFunctionItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
